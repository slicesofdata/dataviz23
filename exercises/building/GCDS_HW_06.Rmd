...
For this homework, you will save the `R Markdown` homework document and save it to "GCDS/r" on your computer. Rename as **"GCDS_HW_06_yourname"**. When you open it, add your name to the author part of the YAML code. The homework will need to be submitted as a `knit` HTML file. Feel free to work with a partner but understand that the work submitted has to be your own.
...
Use `facet_wrap()` to pass separate plots by any ordered factor in the data frame.
