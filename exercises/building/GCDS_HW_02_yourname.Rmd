...
This causes confusion because you will come across instances for which you will need to reference a period (or .data) for the data frame as not all functions understand.
