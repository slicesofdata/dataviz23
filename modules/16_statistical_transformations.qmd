...
The `mean` column still have different value but they are replicated on rows with the same `Event` group. This is because the data are grouped that way. 
