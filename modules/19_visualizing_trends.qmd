...
- [Wilke (2019). *Fundamentals of Data Visualization*. Visualizing Trends](https://clauswilke.com/dataviz/visualizing-trends.html)

Optional:

- [Wickham, Navarro, & Pedersen (under revision). *ggplot2: Elegant Graphics for Data Analysis (3e)*. Time series](https://clauswilke.com/dataviz/time-series.html)
