...
Data visualization is key to understanding data. The major plotting workhorse in `R` is [**{ggplot2}**](https://ggplot2.tidyverse.org/), which is built on    
[Leland Wilkinson's (2005) text on what here called 'The Grammar of Graphics'.](https://link.springer.com/book/10.1007/0-387-28695-0). You can find out more about the motivation for him developing his approach [here](https://link.springer.com/book/10.1007/0-387-28695-0#about-this-book). 
