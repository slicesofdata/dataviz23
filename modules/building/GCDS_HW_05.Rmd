...
Create either a `geom_histogram()` or `geom_density()` plto for a numeric variable of interest.
...
Create either a `geom_histogram()` or `geom_density()` plot for a numeric variable that visualizes a separate histogram for the `Gender` variable on the same plot.
