...
Let's pass the summary procedures as a `list`. Unfortunately, `n()` will throw an error but `length()` will also return the length of the vector, after of course, the grouping variable.
