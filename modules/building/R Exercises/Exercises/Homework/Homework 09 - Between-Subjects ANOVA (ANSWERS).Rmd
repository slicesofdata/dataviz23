...
1. **QUESTION:** Describe the difference between a one-way between-subjects ANOVA and a Factorial between-subjects factorial ANOVA.

*ANSWER:* 


2. **QUESTION:** Describe the purpose of a between-subjects factorial ANOVA.

*ANSWER:*

3. **QUESTION:** For a between-subjects ANOVA, how many independent variables are needed at very least?

*ANSWER:*

4. **QUESTION:** For a 2 x 3 between-subjects factorial ANOVA, how many main effects can you test for?

*ANSWER:*

5. **QUESTION:** For a 2 x 3 between-subjects factorial ANOVA, how many interactions can you test for?
...
1.2. Data for the *two-way between-subjects factorial ANOVA* are grouped on some classification factor, or variable similar to a one-way ANOVA, so that group means can be created based on that classification. In this example, however, there are only two levels of the independent variables shown below (e.g., Gender: Male vs. Female; Student: Yes vs. No). Because both independent variables are between-subjects, there are 4 groups of different respondents. The dependent variable is happiness.  
...
- between men and women (*test for main effect*)
- between those who are students and those who are not students (*test for main effect*)
- as a function of the combination of gender and student IVs (*test for main interaction*)
