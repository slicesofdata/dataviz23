---
title: "Homework 03"
author: "replace this with your names"
...
- hist(); built-in library
- lattice::histogram() for histograms; lattice library
- qqnorm() and qqline() for examining normality; built-in library
- with() ; built-in stats library

## 2. Loading libraries
After you finished the install, use the library() function to load the library by adding your R code in the empty code chunk below (between the ```). Hint: If you don't like typing all those characters out by hand, click on the Code option on the toolbar and learn the keyboard shortcut next to Insert Chunk. 
...
B. Is age the 5th, 6th, or 8th variable?   **ANSWER:** 

C. How many levels are there for genhlth?  **ANSWER:** 
...
D. What is the label on the y-axis?   **ANSWER:**  
...
F. What is the label on the y-axis?   **ANSWER:**
...
G. Based on your graph, do weights appear greater for men or for women?   **ANSWER:**
