...
format:
  html:
    ...
    #body-color: white #; //light-gray;  // page text
#    footer-bg: #AD2EA4      # // footer
   # link-color: lime    # hyperlinks
  #  code-bg: blue #// inline code background color
 #   code-color:  red #orange; //  #$magenta;     // inline code text color
#    code-block-bg: black # // code block background color
