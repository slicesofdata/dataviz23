...
Make sure to read this entirely so that you know the scope of the project. During grading, I will make the assumption you have. 
...
Please make sure to review presentation tips, which will help with the presentation/communication porttion of evaluation.
...
If you are interested in examining data using models that we did not discuss in class (e.g., 2 x 2 factorial ANOVA with interactions, etc.), let me know and I can help or direct you to those solutions. 
...
Please keep correspondence in your private slack channel so that I can see what you are doing and provide help. Upload your report logs there (by 11:59pm on day of class (Thursdays) starting this Thursday, 11/17). The report log will be the same as used for the other project. 

*Some people think the report log is optional. It's not. Please note, each missed weekly report log will result in a letter grade reduction on the project. No exceptions. "But what if...?" No exceptions.*
...
You will be evaluated on your team's ability to convey the steps taken to produce your deliverable for your client (the audience). Your individual performance and contributions will be considered toward the evaluation. 
...
3. Thoroughness of communicating data interpretation 
...
3. Appropriateness and quality of plots
