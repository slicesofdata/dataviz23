...
Looking at the naming convention, you will see files are named by year and school and team and location and event. Underscores separate the names. You might wish to find all files containing another pattern.

If you want to pattern match using "and" (`&`) rather than "or" (`|`), you can use `.+` within the pattern.
...
4. Write out the uber data frame 
